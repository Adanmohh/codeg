...
fn open_pet_panel_window(app: &AppHandle) -> Result<(), AppCommandError> {
    ...
    let builder = WebviewWindowBuilder::new(app, PET_PANEL_LABEL, url)
        .title("Hafidh Ops Desk sessions")
