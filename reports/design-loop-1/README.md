...
Preliminary specialist methods were applied sequentially by root while all three worker slots were occupied; see review.md/findings/merged.json. Final specialists will run through the existing Herdr workers after feature
