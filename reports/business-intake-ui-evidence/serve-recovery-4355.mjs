...
// Dedicated origin4355 preserves all4354/4350 exports and private sessions.
// Inherited helper at60d600db0f224d44ff191490ab79bc25530ba959; see NOTICE.
...
const server = createServer(async (req, res) => {
  ...
  if (req.headers.origin !== undefined && req.headers.origin !== origin) {
    finish(res, 403, "Synthetic fixture origin guard")
    return
  }
