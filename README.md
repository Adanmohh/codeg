...
Internal Hafidh operations workspace, based on [codeg v0.30.4](https://github.com/xintaofei/codeg/tree/6f6bd648b206412644842a98d9ffeebf57292bed) (Apache-2.0). See [NOTICE](NOTICE) for attribution. The documentation below describes the inherited codeg features; its screenshots and release links are upstream references. This fork is an unsigned internal build with application updates disabled.
